...
- [x] `UploadProgressSheet`: avatar, post, story, belge yükleme için ortak progress UI
...
- [ ] Her V2 feature için `Repository` interface'i oluştur — `SocialRepository` tamam
- [ ] `MockSocialRepository`, `MockCommunityV2Repository`, `MockBusinessRepository` — social mock tamam
- [ ] Feature flag:
  - [x] `useMockV2Social = true`
